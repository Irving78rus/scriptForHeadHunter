		...
		setTimeout(() => {
			...
			setTimeout(() => {
				...
				setTimeout(() => {
					...
					letter.innerHTML += "Добрый день! Я начинающий frontend разработчик и написал этот скрипт для автоматической отправки откликов, этим я надеюсь привлечь ваше внимание. Скрипт я разместил в моем GitHub профиле. Ссылка на git есть в моем резюме";
					setTimeout(() => {
